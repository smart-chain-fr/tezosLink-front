...
export default class SuccessfulChip extends React.Component<IProps, IState> {
  ...
  override render(): React.ReactNode {
    return (
      ...
      >
        <div className={classes["content"]}>Successful</div>
      </div>
    );
  }
  ...
  private onClick() {
    if (this.props.clickable && this.props.onClick) {
      this.props.onClick(RequestStatus.SUCCESSFUL);
    }
  }
}
