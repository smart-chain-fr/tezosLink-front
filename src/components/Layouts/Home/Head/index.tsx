    ...
    <div className={classes["root"]}>
      <div className={classes["left-panel"]}>
        <div className={classes["left-content"]}>
          ...
          <h3>
            Free and scalable API access to the Tezos network
            <br />
            and usage analytics for your projects
          </h3>
      ...
      <div className={classes["right-panel"]}>
        <Image
          alt="torus"
          className={classes["torus-cables"]}
          src={TorusCable}
        />
        <Image alt="torus" className={classes["torus-bg"]} src={TorusBg} />
        <Image
          alt="meteor"
          className={classNames(classes["meteor"], classes["meteor1"])}
          src={Meteor}
        />
        <Image
          alt="meteor"
          className={classNames(classes["meteor"], classes["meteor2"])}
          src={Meteor}
        />
        <Image
          alt="meteor"
          className={classNames(classes["meteor"], classes["meteor3"])}
          src={Meteor}
        />
        <Image
          alt="meteor"
          className={classNames(classes["meteor"], classes["meteor4"])}
          src={Meteor}
        />
